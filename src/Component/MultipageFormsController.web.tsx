...
> {
    ...
    handleChangeApplicationNumber = (data: React.ChangeEvent<HTMLInputElement>) => {
        ...
        //     applicantData: { ...prevState.applicantData, [name]: value }
        // }));
    };
    ...
    handleSubmitApplicationModal = (changeModalEvent: React.FormEvent<HTMLFormElement>) => {
        ...
        if (hasErrors) {
            ...
            const {
                items, applicationNumber, applicantName, applicantAddress, applicantPincode, applicantCity, applicantState, applicantCountry
            }: any = this.state;
            const { name, value }: any = changeModalEvent.target;
